...
(function () {
  ...
  var VIDEO_MODELS = {
    'local-comfy': { label: 'Cinamate AI', resolutions: ['480p', '720p', '1080p'], aspectRatios: ['16:9', '9:16', '1:1'], durations: [2, 4, 5, 6, 8, 10, 15], supportsReferences: true, maxRefImages: 4, description: 'Cinamate AI — renders on your own machine through the Cinamate bridge (127.0.0.1:3456)' }
  };
