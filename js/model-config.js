...
(function () {
  ...
  function injectDropdownStyles() {
    ...
    s.textContent = [
      ...
      '.sb-dd-btn:focus{outline:none;border-color:var(--gold,#ff7350);box-shadow:0 0 0 2px rgba(255,115,80,.15)}',
      ...
      '.sb-dd-item:hover,.sb-dd-item.sb-dd-on{background:rgba(255,115,80,.12);color:var(--gold,#ff7350)}',
